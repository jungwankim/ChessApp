	...
	return (

		{
			board : {
				 ...
				 B : ['w@bishop1', 'w@pawn2',  null, null, null, null,  'b@pawn2', 'b@bishop1'],
				 C : ['w@knight1', 'w@pawn3',  null, null, null, null, 'b@pawn3', 'b@knight1'],
				 D : ['w@queen1', 'w@pawn4',  null, null, null, null,  'b@pawn4', 'b@queen1'],
				 E : ['w@king1', 'w@pawn5',  null, null, null, null,  'b@pawn5', 'b@king1'],
				 F : ['w@knight1', 'w@pawn6',  null, null, null, null,  'b@pawn6', 'b@knight2'],
				 G : ['w@bishop2', 'w@pawn7',  null, null, null, null,  'b@pawn7', 'b@bishop2'],
				 H : ['w@rock2', 'w@pawn8',  null, null, null, null,  'b@pawn8', 'b@rock2'],
			},
			whitePieceOnBoard : {
				rock1: { id: "w@rock1", loc : "A1", type: "rock"},
				rock2: { id: "w@rock2", loc : "H1", type: "rock"},
				knight1: { id: "w@knight1", loc: "C1", type: "knight"},
				knight2: { id: "w@knight2", loc: "F1", type: "knight"},
				bishop1: { id: "w@bishop1", loc: "B1", type: "bishop"},
				bishop2: { id: "w@bishop2", loc: "G1", type: "bishop"},
			...
			blackPieceOnBoard : {
				...
				knight1: { id: "b@knight1", loc: "C8", type: "knight"},
				knight2: { id: "b@knight2", loc: "F8", type: "knight"},
				bishop1: { id: "b@bishop1", loc: "B8", type: "bishop"},
				bishop2: { id: "b@bishop2", loc: "G8", type: "bishop"},
